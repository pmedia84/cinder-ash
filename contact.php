                ...
                <div class="grid-row-2col my-3">
                    <div class="grid-col">
                        ...
                        <ul class="contact-details fa-ul" role="list">
                            <li><span class="fa-li"><i class="fa-solid fa-phone"></i></span><span class="sr-only">Phone:</span> <span><a href="tel:01406 258382">01406 258382</a> </span></li>
                            <li><span class="fa-li"><i class="fa-solid fa-envelope"></i></span><span class="sr-only">eMail:</span> <span><a href="mailto:cinderashpre-school@hotmail.co.uk"> cinderashpre-school@hotmail.co.uk</a></span></li>
