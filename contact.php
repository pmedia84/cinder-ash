                ...
                <div class="grid-row-2col my-3">
                    <div class="grid-col">
                        ...
                        <ul class="contact-details fa-ul" role="list">
                            ...
                            <li><span class="fa-li"><i class="fa-solid fa-mobile"></i></span><span class="sr-only">Mobile:</span> <span><a href="tel:07496751174" itemprop="telephone">07496751174</a> </span></li>
