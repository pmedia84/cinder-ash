...
/**
 * Script for processing the request info form and sending notification emails to admins
 */
...
if (isset($_POST['token']) && $_POST['token'] != '') {
    ...
    if ($score >= 0.7) {
        ...
        $subject = 'New Information Request - ' . $visitor_name;

        $body = '
        <div style="background-color:#a67d6e; padding:16px; font-family:sans-serif;">
            <h1 style="text-align:center; color:white;">New Information Request</h1>
        ...
        if (!$mail->Send()) {
            ...
            echo json_encode(['success' => true, 'message' => 'Thank you, <strong>' . $visitor_name . '</strong>! We have received your request and will be in touch very soon.']);
        }
    } else {
