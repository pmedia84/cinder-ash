...
/////////////////////////////////////////////////////////Send Emails /////////////////////////////////////////////////////////////////
   ...
   // stored in seperate file
    ...
    ///////////////////Admins auto reply/////////////////////////
        //email subject
        $subject = $visitor_name .' has requested more information';


        //body of email for website admins
        $body = '<div style="background-color:#a67d6e; padding:16px;font-family:sans-serif;">
            <h1 style="text-align:center; color:white;">' . $visitor_name .' has requested more information.</h1>
        ...
        if (!$mail->Send()) {
            ...
            $response="<div class='form-response'><p>Thank you <strong>$visitor_name</strong>"; 
    }
