...
<link rel="canonical" href="https://<?= $_SERVER['SERVER_NAME']; ?>/prices">
    ...
    <main>
        ...
        <section class="container my-4" id="section-one">
            ...
            <table class="std-table">
                ...
                <p class="my-2">Invoices are sent out at the beginning of each month for payment within 14 days.</p>
                <p>Children accessing all year round fee paying contracts can request 4 weeks of holiday leave, only charged at 50% (this does not apply to term time only children).</p>
            </div>
